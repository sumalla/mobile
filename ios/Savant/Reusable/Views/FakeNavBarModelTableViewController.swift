//
//  FakeNavBarModelTableViewController.swift
//  Savant
//
...
class FakeNavBarModelTableViewController: ModelTableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.contentInset = UIEdgeInsets(top: Sizes.row * 8, left: 0, bottom: 0, right: 0)
    }
