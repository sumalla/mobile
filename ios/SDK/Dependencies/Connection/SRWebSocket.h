...
/**
 *  Returns the negotiated protocol. This will be nil until after the handshake.
 */
...
/**
 *  Initializes an SRWebSocket with the given request and protocols.
 *
 *  @param request   The request.
 *  @param protocols The protocols. This should be an array of strings that will turn into Sec-WebSocket-Protocol.
 *
...
/**
 *  Initializes an SRWebSocket with the given request and nil protocols.
 *
 *  @param request The request.
 *
 *  @return An initialized SRWebSocket.
...
/**
 *  Initializes an SRWebSocket with the given URL and protocols.
 *
 *  @param url       The URL.
 *  @param protocols The protocols. This should be an array of strings that will turn into Sec-WebSocket-Protocol.
 *
