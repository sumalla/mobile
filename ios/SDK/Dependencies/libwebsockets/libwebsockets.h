...
LWS_EXTERN int
libwebsocket_get_listen_port(struct libwebsocket_context *context);
...
LWS_EXTERN void
lws_allow_moving_write_buffer(struct libwebsocket *wsi);
